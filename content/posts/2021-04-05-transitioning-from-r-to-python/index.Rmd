...
The support to Object Oriented Programming (OOP), [Functional Programming](https://www.youtube.com/watch?v=0if71HOyVjY) (FP) and Procedutal Programming (PP) is another aspect that I judge noteworthy. Mostly tutorials and content about Python in the internet are for developers. So the OOP is a word in the mouth of ever Python user. However, most scientists are more familiar with PP and FP. Luckily, most of the exploratory data analysis are based in PP.
